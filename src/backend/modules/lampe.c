#include "../core/domotique.h"        // Fonctions utilitaires : gestion du JSON, helpers HTML, etc.
#include "../core/socket_client.h"    // Fonctions réseau pour communiquer avec le simulateur
