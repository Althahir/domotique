...
/* ---------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------- */
// Dossier des fichiers de données (chemin relatif depuis cgi-bin/)
#define STATE_DIR "..\\htdocs\\c\\src\\backend\\data\\"

// Fichiers JSON utilisés par le système
#define STATE_JSON        "devices.json"
#define STATE_JSON_SAVE   "devices_save.json"
#define STATE_LOG         "debug.log"

// Chemins complets construits par concaténation
#define STATE_JSON_PATH       STATE_DIR STATE_JSON
#define STATE_JSON_SAVE_PATH  STATE_DIR STATE_JSON_SAVE
#define DEBUG_LOG_PATH        STATE_DIR STATE_LOG
